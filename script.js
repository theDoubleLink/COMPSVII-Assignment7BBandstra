...
let favoriteFoods = ["Pizza","Sushi","Coke","Ice Cream","Soft Pretzel","Pineapple" ]
...
// ...etc.
for (let i = 0; i < favoriteFoods.length; i++) {
  console.log("My #" + (i+1) + " is " + favoriteFoods[i]);
}
...
console.log("Foods that include the letter 'a':");
...
let longest = friendFavorites.reduce((best, current) =>
